...
!macro deleteTabTinCredentials
  Delete "$APPDATA\QiZhiKitty\credentials.json"
  Delete "$APPDATA\QiZhiKitty Community\credentials.json"
  Delete "$APPDATA\QiZhiKitty Dev\credentials.json"
  Delete "$APPDATA\QiZhiKitty Local\credentials.json"
  Delete "$APPDATA\QiZhiKitty Preprod\credentials.json"
...
!macro wipeTabTinLocalData
  !insertmacro wipeTabTinProfileConfig "$APPDATA\QiZhiKitty"
  !insertmacro wipeTabTinProfileConfig "$APPDATA\QiZhiKitty Community"
  !insertmacro wipeTabTinProfileConfig "$APPDATA\QiZhiKitty Dev"
  !insertmacro wipeTabTinProfileConfig "$APPDATA\QiZhiKitty Local"
  !insertmacro wipeTabTinProfileConfig "$APPDATA\QiZhiKitty Preprod"
  ...
  RMDir /r "$LOCALAPPDATA\com.qizhikitty.community-updater"
  RMDir /r "$LOCALAPPDATA\com.qizhikitty.app-updater"
  RMDir /r "$LOCALAPPDATA\com.qizhikitty.app.local-updater"
  RMDir /r "$LOCALAPPDATA\QiZhiKitty-updater"
  RMDir /r "$LOCALAPPDATA\QiZhiKitty Community-updater"
