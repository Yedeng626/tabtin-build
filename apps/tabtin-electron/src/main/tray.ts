...
const TRAY_LABELS: Record<StartupUiLocale, TrayLabels> = {
  'zh-CN': {
      ...
      open: '打开 QiZhiKitty',
      quit: '退出',
      hiddenHintTitle: 'QiZhiKitty 仍在后台运行',
      hiddenHintBody: '窗口已隐藏。点击托盘 / 菜单栏图标，或点击任务栏 / Dock 图标可重新打开。可在设置中关闭此行为。',
  },
  'zh-TW': {
    tooltip: 'QiZhiKitty', open: '開啟 QiZhiKitty', quit: '結束', hiddenHintTitle: 'QiZhiKitty 仍在背景執行',
    hiddenHintBody: '視窗已隱藏。點擊系統匣 / 選單列圖示，或工作列 / Dock 圖示即可重新開啟。你可以在設定中關閉此行為。',
  },
  'en-US': {
    tooltip: 'QiZhiKitty',
    open: 'Open QiZhiKitty',
    quit: 'Quit',
    hiddenHintTitle: 'QiZhiKitty is still running',
  ...
  'ja-JP': {
    tooltip: 'QiZhiKitty', open: 'QiZhiKitty を開く', quit: '終了', hiddenHintTitle: 'QiZhiKitty はバックグラウンドで実行中です',
    hiddenHintBody: 'ウィンドウは非表示になりました。トレイ / メニューバー、タスクバー / Dock のアイコンをクリックすると再度開けます。この動作は設定で変更できます。',
  },
  'ko-KR': {
    tooltip: 'QiZhiKitty', open: 'QiZhiKitty 열기', quit: '종료', hiddenHintTitle: 'QiZhiKitty이 백그라운드에서 실행 중입니다',
    hiddenHintBody: '창이 숨겨졌습니다. 트레이 / 메뉴 막대 또는 작업 표시줄 / Dock 아이콘을 클릭하여 다시 열 수 있습니다. 설정에서 이 동작을 변경할 수 있습니다.',
  },
  'de-DE': {
    tooltip: 'QiZhiKitty', open: 'QiZhiKitty öffnen', quit: 'Beenden', hiddenHintTitle: 'QiZhiKitty wird im Hintergrund ausgeführt',
  ...
  'fr-FR': {
    tooltip: 'QiZhiKitty', open: 'Ouvrir QiZhiKitty', quit: 'Quitter', hiddenHintTitle: 'QiZhiKitty s’exécute toujours en arrière-plan',
  ...
  'es-ES': {
    tooltip: 'QiZhiKitty', open: 'Abrir QiZhiKitty', quit: 'Salir', hiddenHintTitle: 'QiZhiKitty sigue ejecutándose en segundo plano',
