...
interface TabTinAPIShape {
  ...
  ensureDeviceRegistered: (organizationId: string, force?: boolean) => Promise<Device>
...
const api = {
  ...
  ensureDeviceRegistered: (organizationId: string, force?: boolean) =>
    invokeIpc('device:ensureRegistered', { organizationId, force }),
