...
import { AUTH_EMAIL_LOGIN_ENABLED, AUTH_PHONE_LOGIN_ENABLED } from '@/utils/featureFlags'
    ...
    >
      <div className="text-center mb-8">
        ...
        <p className="text-muted-foreground">
          {form.step === 'request'
            ? t(identifierCopy.forgotSubheading)
          ...
          <FormField>
            ...
            <div className="relative">
              <Input
                ...
                placeholder={t(identifierCopy.forgotPlaceholder)}
