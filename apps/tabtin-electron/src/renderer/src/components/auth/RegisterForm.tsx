...
import { AUTH_EMAIL_LOGIN_ENABLED, AUTH_PHONE_REGISTER_ENABLED } from '@/utils/featureFlags'
...
export const RegisterForm: React.FC<RegisterFormProps> = ({
  ...
  // 注册标识符：由「手机号注册开关」决定；关闭时只收邮箱（既有手机号账号登录不受影响）
  const identifierMode = resolveAuthIdentifierMode(AUTH_EMAIL_LOGIN_ENABLED, AUTH_PHONE_REGISTER_ENABLED)
    ...
    >
      <div className="text-center mb-8">
        ...
        <p className="text-muted-foreground">
          {t(identifierCopy.registerSubheading)}
        </p>
      </div>
      ...
      <Form onSubmit={form.submit}>
        ...
        <FormField>
          <FormLabel htmlFor="phone">
            {t(identifierCopy.registerLabel)}
          </FormLabel>
          <div className="relative">
            <Input
              ...
              placeholder={t(identifierCopy.registerPlaceholder)}
