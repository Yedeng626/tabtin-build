...
def _update_enum_values(apps, schema_editor, forward=True):
    ...
    with schema_editor.connection.cursor() as cursor:
        cursor.execute(
            "UPDATE skills_skill SET visibility = %s WHERE visibility = %s", [new, old]
        )
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('skills', '0009_skill_quick_use_json'),
    ]

    operations = [
        migrations.RenameField(model_name='skill', old_name='workteam_id', new_name='organization_id'),
