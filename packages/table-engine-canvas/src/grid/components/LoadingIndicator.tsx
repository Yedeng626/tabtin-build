...
import { MagicAi, Square } from '../../icons/inlineIcons';
...
export const LoadingIndicator = (props: ILoadingIndicatorProps) => {
  ...
  return (
    <div className="pointer-events-none absolute left-0 top-0 z-sticky">
        ...
        return (
          ...
          >
            <div className="absolute right-1 top-1 rounded-full bg-background">
              <div className="absolute inset-1 animate-ping rounded-full bg-warning/30" />
              ...
              <div className="size-6 p-1">
                <MagicAi className="size-4 text-warning" />
              </div>
            </div>
          </div>
        );
