...
export const TABTIN_USER_DATA_DIR_NAMES = [
  // 当前品牌（QiZhiKitty）：社区档产品名与正式版同名，但 userData 目录仍带档位后缀
  'QiZhiKitty',
  'QiZhiKitty Community',
  // 历史 TabTin 档位：老安装残留仍需清理
  'TabTin',
  'TabTin Dev',
  'TabTin Local',
  'TabTin Preprod',
...
export const TABTIN_UPDATER_CACHE_DIR_NAMES = [
  'com.qizhikitty.community-updater',
  'QiZhiKitty Community-updater',
  'QiZhiKitty-updater',
  // 历史 TabTin updater 缓存
